...
public class SolarSystemController : MonoBehaviour
{
    ...
    // Penser à faire des listes de liste plutot que des tableaux pour l'evolution du code
    ...
    public void UpdatePosition(DateTime t)
    {
        ...
        for(int i=0; i< PlanetTransform.Length; i++) {
            ...
            //Debug.Log(PlanetTransform[i].position);
    ...
    public void SetLineRenderer() {
        ...
        Debug.Log("fonction lancé");

        time = DateTime.Now;

        // Mes listes pour avoir les positions des planetes. Penser à faire une liste de liste pour l'evolution du code
        ...
        //Revolution en nombre de jours terrestres


        // Mercure prend 88 jours max pour tourner  autour du soleil
        for (int i = 0; i < 89; i++)
        {
            //Debug.Log("Le time " + i + "est: " + time);
        ...
        // Venus prend 225 jours max pour tourner  autour du soleil
        for (int i = 0; i < 226; i++)
        {
        ...
        // La terre prend 366 jours max pour tourner  autour du soleil
        for (int i= 0; i < 367; i++)
        {
        ...
        // Mars prend 687 jours max pour tourner  autour du soleil
        for (int i = 0; i < 688; i++)
        {
        ...
        // Jupiter prend 4333 jours max pour tourner  autour du soleil
        ...
        // Saturne prend 10760 jours max pour tourner  autour du soleil
        ...
        // Uranus prend 30686 jours max pour tourner  autour du soleil
        for (int i = 0; i < 30687; i++)
        {
            listUranus.Add(PlanetData.GetPlanetPosition((PlanetData.Planet)6, time));
            //Debug.Log("la " + i + " ieme valeur de la liste mercury est: " + listUranus[i]);
            time = time.AddDays(1);
        }
        ...
        // Neptune prend 60266 jours max pour tourner  autour du soleil
